...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@MX_W9"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@R2_3R"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@O_B_OB"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس عمرو🇪🇬😎 يعمل بنجاح ⚡️**')
...
💞 مرحبا بك في اوامر  KING AMR [ @LX_0W ]
    ...
    if sender.id == ownerhson_id:
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | AMR")
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | ᯓ 𓆩 ˹𝙰𝙼𝚁˼ 𓆪☬,࿅ 𓀎")
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس الملك عمرو**')
